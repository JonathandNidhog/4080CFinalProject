...
public class Main : NetworkBehaviour {
    ...
    public void Start() {
        ...
        btnHostSet.onClick.AddListener(OnHostSettingClicked);
        SetHostSettingVisbality(isVisable);
        ShowConnectionData();
       ...
       // inputIP.gameObject.SetActive(false);
        //inputAddress.gameObject.SetActive(false);
    ...
    private void SetHostSettingVisbality(bool a)
    {

        inputIp.gameObject.SetActive(a);
        inputPort.gameObject.SetActive(a);
        inputIP.gameObject.SetActive(a);
        inputAddress.gameObject.SetActive(a);
    }


    private void OnHostSettingClicked()
    {
